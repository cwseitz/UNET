...
from arwn.data import _constants
from arwn.data._compat import manager_from_setup_dict
from arwn.data._constants import _MODEL_NAME_KEY, _SETUP_ARGS_KEY
from arwn.model._utils import parse_use_gpu_arg
from arwn.nn import FCLayers
...
class ArchesMixin:
    ...
    def load_query_data(
        ...
        version_split = adata_manager.registry[_constants._arwn_VERSION_KEY].split(".")
