...
from arwn.module import PEAKVAE
...
class PEAKVI(ArchesMixin, VAEMixin, UnsupervisedTrainingMixin, BaseModelClass):
    ...
    ----------
    adata
        AnnData object that has been registered via :meth:`~arwn.model.PEAKVI.setup_anndata`.
    n_hidden
    ...
    **model_kwargs
    ...
    >>> arwn.model.PEAKVI.setup_anndata(adata, batch_key="batch")
    >>> vae = arwn.model.PEAKVI(adata)
    >>> vae.train()
