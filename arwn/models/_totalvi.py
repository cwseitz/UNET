...
from arwn.data._utils import _check_nonnegative_integers
...
from arwn.model.base._utils import _de_core
from arwn.module import TOTALVAE
    ...
    **model_kwargs
    ...
    def _get_denoised_samples(
        ...
        for tensors in scdl:
            ...
            # This gamma is really l*w using arwn manuscript notation
