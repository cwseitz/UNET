...
from arwn.data.fields import LayerField
from arwn.module import AmortizedLDAPyroModule
...
class AmortizedLDA(PyroSviTrainMixin, BaseModelClass):
    ...
    ----------
    adata
        AnnData object that has been registered via :meth:`~arwn.model.AmortizedLDA.setup_anndata`.
    n_topics
    ...
    >>> arwn.model.AmortizedLDA.setup_anndata(adata)
    >>> model = arwn.model.AmortizedLDA(adata)
    >>> model.train()
